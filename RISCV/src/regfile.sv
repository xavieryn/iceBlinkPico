...
module regfile (
    ...
    // Reads
    input logic [4:0] address1, // two different registers (32 registers can be shown in 5 bits)
    input logic [4:0] address2, // good for r - r type instructions (add, subtract etc)
    output logic [31:0] read_data1, // 32 bit data
